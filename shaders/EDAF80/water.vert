...
void main()
{
    ...
    tangents = vec3(1,derivative(vertex.xz, vec2(-1.0, 0.0), 0.2, 3.0, 1.0, 2.0, elapsed_time)*-1+derivative(vertex.xz, vec2(1.0, 0.5), 0.15, 2.0, 1.5, 3.0, elapsed_time),0);
    binormals = vec3(0,derivative(vertex.xz, vec2(-1.0, 0.0), 0.2, 3.0, 1.0, 2.0, elapsed_time)*0+derivative(vertex.xz, vec2(1.0, 0.5), 0.15, 2.0, 1.5, 3.0, elapsed_time)*0.5,1);
    
    vs_out.normal = vec3(derivative(vertex.xz, vec2(-1.0, 0.0), 0.2, 3.0, 1.0, 2.0, elapsed_time) + derivative(vertex.xz, vec2(1.0, 0.5), 0.15, 2.0, 1.5, 3.0, elapsed_time), 1.0, 0.0); 
