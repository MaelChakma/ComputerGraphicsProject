...
parametric_shapes::createSphere(float const radius,
	...
	{
	auto const rectangle_count = longitude_split_count + 1u;
	auto const vertices_count = rectangle_count + 1u;
