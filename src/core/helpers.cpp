						   ...
						   bool generate_mipmap)
{
	...
	auto datanegy = getTextureData(negy, width, height, false);
	auto dataposy = getTextureData(posy, width, height, false);
	auto datanegz = getTextureData(negz, width, height, false);
	auto dataposz = getTextureData(posz, width, height, false);
